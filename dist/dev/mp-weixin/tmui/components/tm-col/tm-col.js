  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        d: common_vendor.s(!__props.transprent ? common_vendor.unref(tmcomputed).backgroundColorCss : ""),
        e: common_vendor.s({
          alignItems: common_vendor.unref(alignComputed),
          justifyContent: common_vendor.unref(alignComputed)
        }),
        f: common_vendor.s(common_vendor.unref(customCSSStyle)),
        ...
        k: common_vendor.s({
          width: common_vendor.unref(colWidth) + "px"
        }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/tmuidome/src/tmui/components/tm-col/tm-col.vue"]]);
